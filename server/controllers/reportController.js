...
//get all high scorer students grouping by their grade level once
exports.getHighScorer = async (req, res) => {
    const {  academicYear } = req.query;
    ...
    try {
        ...
        const students = await Student.find({status: 'Active' })
            .select('studentId fullName gender dateOfBirth photoUrl gradeLevel')
