...
const StandardCertificate = ({ students, semester, awardDate, academicYear, grade }) => {
    ...
    return (
        <div className="flex flex-col items-center gap-10 bg-gray-200 py-10 print:bg-white print:py-0">
            <style>{`
                @import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@400;750;900&family=Inter:wght@400;750;800&family=Noto+Sans+Ethiopic:wght@400;750&display=swap');
            ...
            {students && students.map((student) => {
                ...
                return (
                    <div key={student.studentId || student._id} className="print-page-standard shadow-2xl">
                        ...
                        {/* MAIN CONTENT BOX */}
                        <div className="inner-content my-auto">
                            
                            <div className="flex flex-col items-center gap-3 mb-2 no-print">
                                <img src={schoolInfoData.logo} alt="School Logo" className="w-30 h-30 object-contain rounded-full border border-slate-200" />
                                <span className="text-4xl font-main font-black uppercase tracking-wider text-[#2B4C7E]">
                                    {schoolInfoData.name}
                                </span>
                            </div>
                            ...
                            {/* Title Section */}
                            <div className="mt-2">
                                <h1 className="text-2xl font-main font-extrabold text-[#d97706] tracking-tighter mb-0">Certificate Of Achievement</h1>
                            </div>

                            {/* Name Section */}
                            <div className="mt-4 w-full">
                                <h2 className="text-3xl font-main font-black text-black uppercase tracking-tight mb-2">
                                    {student.fullName}
                                </h2>
                                <div className="w-1/2 h-0.5 bg-gray-300 mx-auto"></div>
                            </div>

                            <div className="grid grid-cols-2 gap-8 w-full max-w-5xl px-6 mt-4 flex-1">
                                ...
                                <div className="text-left pl-6 flex flex-col justify-center">
                                    <p className="text-gray-600 font-main text-sm leading-relaxed">
                                        This is to certify that the student has shown exceptional academic performance and exemplary conduct, 
                                        achieving <span className="font-bold text-black">{englishRankStr} Place</span> in <strong>{grade}</strong> with <strong>{student.avg}%</strong>.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mt-auto w-full flex justify-between items-end px-16 mb-4">
                                ...
                                <div className="text-center w-64">
                                    <div className="border-b-2 border-gray-400 pb-1 font-bold text-lg"/>
                                    <p className="mt-2 text-xs font-bold text-gray-500 uppercase tracking-widest">Homeroom Teacher</p>
                                </div>
                                ...
                                <div className="relative">
                                    <svg width="120" height="120" viewBox="0 0 100 100">
                                        ...
                                        <text x="50" y="65" textAnchor="middle" fill="#FFD166" fontSize="14" fontWeight="black" fontFamily="Arial">{rankNum}</text>
                                    </svg>
                                </div>
                                ...
                                <div className="text-center w-64">
                                    ...
                                    <p className="mt-2 text-xs font-bold text-gray-500 uppercase tracking-widest">School Director</p>
                                </div>
                            </div>
                        </div>
                    </div>
